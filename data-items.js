window.masterItems = [
  ...
  { id: "item_obs_sheet", name: "観察記録票", tags: ["観察", "記録", "生物", "生態目録"], note: "観察対象がいる依頼で持たせると、報告書に冒険者ごとの観察メモが追加される。" },
  { id: "item_lantern", name: "ランタン", tags: ["夜道", "灯り", "調査"], note: "夜道や暗所で足元と帰り道を確認するための支給品。" },
  { id: "item_smoke", name: "煙幕", tags: ["撤退", "回避", "戦闘"], note: "各人の撤退判断を早め、撤退が成立すれば煙幕を焚いて戦闘を回避し先へ進める。" }
];
