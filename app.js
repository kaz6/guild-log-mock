...
const RECEPTIONIST_REPORT_TEMPLATE = {
  logs: [
    // ★ 2026-09-22・EX-142【2】：「私、アルメナが」と名乗りを入れた（チャット側の指示）。
    //   ★ **これが受付嬢の最初の名乗り**（名乗りの演出は未実装で、名前は 2026-08-03 に確定していた）。
    { kind: "", text: "本日は遠征をお休みして、ギルドの大掃除を行いました。記録は僭越ながら、私、アルメナがつけております。" },
