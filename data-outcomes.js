...
window.masterOutcomeTexts = {
  ...
  // ★ 調査ジャンルの1件目（2026-09-15・EX-106。文面は EX-108 で本置き）。★ 結末名は依頼をまたいで1つの表に畳まれるので、
  //   既出と衝突しない語を選んである（発見／観察優先／異常なし／再確認／痕跡確認／保存優先 はすべて既出）。
  quest_unknown_grass: {
    "群生確認": {
      result: "群生確認",
      summary: "草の広がりを端まで確かめ、範囲を書き留めた。",
      line: "{慎重}は群れの縁を一周し、途切れる場所に印を残した。",
      after: "どこまで在るかは分かった。何であるかは分からない。",
      history: "窪地の草の広がりを確かめた。"
    },
    "標本確保": {
      result: "標本確保",
      summary: "葉と根を傷めずに持ち帰り、押して乾かした。",
      line: "{薬草師}は素手で触れず、布を敷いてから根ごと掘った。",
      after: "机の上で、灰色の葉は少しだけ縮んで見える。",
      history: "窪地の草を一株持ち帰った。"
    },
    "採取見送り": {
      result: "採取見送り",
      summary: "見て書き留めるに留め、持ち帰りは見送った。",
      line: "{一行}は触れるかどうかを相談し、触れないことにした。",
      after: "判断は正しかったのかもしれない。確かめる方法がない。",
      history: "窪地の草を見るだけにして戻った。"
    }
  },
  quest_signpost: {
    "成功": {
