...
window.masterOutcomeTexts = {
  ...
  // ★ 調査ジャンルの1件目（2026-09-15・EX-106）。★ 結末名は依頼をまたいで1つの表に畳まれるので、
  //   既出と衝突しない語を選んである（発見／観察優先／異常なし／再確認／痕跡確認／保存優先 はすべて既出）。
  //   ⚠️ 文面は仮置き。チャット側が書き直す前提。
  quest_unknown_grass: {
    "群生確認": {
      result: "群生確認",
      summary: "窪地の一角にまとまって出ていることが分かった。持ち帰りはしていない。",
      line: "{一行}は草を抜かず、生えている範囲の端から端までを歩いて確かめた。",
      after: "報告書には、窪地の形と、草の生えていた縁の位置が書き添えてあった。",
      history: "森の際の見慣れない草の確認で、群れの範囲を記録。"
    },
    "標本確保": {
      result: "標本確保",
      summary: "一株だけを根ごと持ち帰った。残りには手をつけていない。",
      line: "{薬草師}は端の一株だけを選び、根を傷めないように土ごと包んだ。",
      after: "包みは受付の棚に置かれた。名前が付くまでは、これが唯一の現物になる。",
      history: "森の際の見慣れない草の確認で、標本を一株持ち帰った。"
    },
    "採取見送り": {
      result: "採取見送り",
      summary: "見て書き留めるだけにした。採取は次回に持ち越し。",
      line: "何なのか分からないうちは触らない方がいい、と{慎重}が言った。{一行}は形と丈だけを書き留めた。",
      after: "報告書の最後には「次は乾いた日に」とだけ書いてある。",
      history: "森の際の見慣れない草の確認で、採取は見送り。"
    }
  },
  quest_signpost: {
    "成功": {
  ...
  quest_tavern_errand: {
    "成功": {
      result: "成功",
      summary: "酒樽をギルドまで運び込んだ。代金はギルドの財布から出た。",
      line: "{一行}は酒場の主人から樽を受け取り、そのままギルドの裏口まで運び込んだ。代金はギルドの財布から出た。",
      after: "受付の脇に置かれた樽を見て、受付嬢は「これで格好がつきます」と言った。就任祝いは夕方から。",
      history: "隣の酒場へ買い出し。就任祝いの酒樽を運び込んだ。"
    },
    "上機嫌": {
      result: "上機嫌",
      summary: "酒場の主人が上機嫌で、頼んだより良い樽を出してくれた。",
      line: "話を聞いた酒場の主人は「新しい記録係さんに」と言って、頼んだのより一つ良い樽を出した。差額は取らなかった。",
      after: "報告書の末尾には「差額なし。主人の厚意」とだけ書いてある。こういう行はあとで効く。",
      history: "隣の酒場へ買い出し。主人の厚意で上等な樽を受け取った。"
    },
    "寄り道": {
      result: "寄り道",
      summary: "樽は運び込んだが、少し手間取って戻りが遅れた。",
      line: "樽は無事に届いたが、道の途中で持ち替えが必要になり、戻りは思ったより遅くなった。",
      after: "受付嬢は時計を見て、それから何も言わずに樽の栓を確かめた。",
      history: "隣の酒場へ買い出し。運搬に手間取り、戻りが遅れた。"
    },
    "出直し": {
      result: "出直し",
      summary: "樽を持ち帰れず、日を改めることになった。",
      line: "樽は今日のうちには運べなかった。酒場の主人は「置いておくよ」と言い、{一行}は手ぶらで戻った。",
      after: "受付嬢は「では明日にしましょう」と書き足した。就任祝いは一日ずれた。",
      history: "隣の酒場へ買い出し。運べず、日を改めることになった。"
    }
  },
